...
export default function CreateQuizDrawer({openDrawer, onCloseDrawer}) {
    const { isOpen, onClose } = useDisclosure({isOpen:openDrawer, onClose:onCloseDrawer})
        ...
        >
          ...
          <DrawerContent>
            ...
            <DrawerBody>
              <Stack spacing='24px'>
                <Box>
                <FormControl display='flex' alignItems='center' mt={2} justifyContent='space-between'>
